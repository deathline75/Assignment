    ...
    <table id="cartTable"  class="cart table table-condensed" >  
        ...
        <tbody>  
            <tr> 
                ...
                <td class="operation"><span class="delete btn btn-xs btn-primary">Delete</span></td>  
            </tr>
        </tbody>  
    </table>  
        ...
        <div class="col-md-12 col-lg-12 col-sm-12">  
            <div style="border-top:1px solid gray;padding:4px 10px;">  
                <div style="margin-left:20px;" class="pull-right total">  
                    <label>Total:<span class="currency">$</span><span id="priceTotal" class="large-bold-red">0.00</span></label>  
                </div>  
                <div class="pull-right">  
                    <label>Selected<span id="itemCount" class="large-bold-red" style="margin:0 4px;"></span>x Items .Total<span id="qtyCount" class="large-bold-red" style="margin:0 4px;"></span> x Games</label>  
                </div>  
